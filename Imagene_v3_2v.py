...
def evaluate(model , test , Y_test, select_label_var_list, prefix, model_type, data_type, label_type, tagDir, gridsearch):
    ...
    label_resulted=[]
    if(model_type == 'RandomForest' or model_type == 'DecisionTreeClassifier' or model_type == 'MLPClassifier' or model_type == 'LogisticRegression'):
        for l in select_label_var_list:
            ...
            if(AUC_value>0.75 and r2_score_dict[l]>0.25):
